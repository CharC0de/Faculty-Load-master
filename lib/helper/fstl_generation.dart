...
class FstlGenHelpers{
  ...
  static String getMergedSchedule(List<Map<String, dynamic>> schedule) {
...
// building the pdf from scrtch while maintaining strict formatting requirements of the original fstl
    pdf.addPage(
      pw.Page(
